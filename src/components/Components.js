  ...
  <Store.Consumer>
    {value => (
      <div className="loader-container" data-testid="loader">
        <Loader
          type="ThreeDots"
          color={value.theme ? '#ffffff' : 'black'}
          height="50"
          width="50"
        />
      </div>
    ...
    {value => (
      <Container style={{alignSelf: 'stretch'}} className="noData" gap="16px">
        <Img
          ...
          alt="failure view"
        />
        <Heading color={value.theme ? 'white' : 'black'}>
...
export const BannerSmall = ({Icon, title}) => (
  <Store.Consumer>
    {value => (
      <Container
        className="trending_heading_container"
        bg={value.theme ? 'black' : '#d7dfe9'}
        data-testid="banner"
      >
        <Container
          className="trending_heading_icon"
          bg={value.theme ? '#231f20' : '#cbd5e1'}
        >
          <Icon size={24} />
        </Container>
...
export const NotFound = () => (
  <Store.Consumer>
    {value => (
      <Container
        style={{alignSelf: 'stretch', padding: 8, textAlign: 'center'}}
        className="noData"
        gap="16px"
      >
        <Img
